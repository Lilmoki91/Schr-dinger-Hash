...
def main():
    ...
    print("=" * 60)
    print(f"🌐 Flask Verify API: Port {PORT}")
    print(f"🤖 Bot Webhook: Port {PORT}")
    print("=" * 60)
    ...
    if RENDER_EXTERNAL_URL:
        application.run_webhook(listen="0.0.0.0", port=PORT, url_path=TOKEN, webhook_url=f"{RENDER_EXTERNAL_URL}/{TOKEN}")
    else:
